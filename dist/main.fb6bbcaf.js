...
function invoke() {
  var primaryNavBtns = document.querySelectorAll('.nav--primary > .nav__item');

  function handleNavRadius() {
    var radiusNavItem = document.getElementById('js-nav--radius');
  ...
  Array.from(primaryNavBtns).forEach(function (btn) {
    return btn.addEventListener('click', handleNavRadius);
  });
}
